export default function Footer() {
    return (
        <footer className="flex flex-col bg-slate-100 items-center justify-center align-middle w-full p-8 text-center">
              <a href="mailto:contact@tiqahfondation.com" target="_blank" className="mt-5 text-[--tiqah-blue]">contact@tiqahfondation.com</a>
              <p className="inline-flex mt-5">
                <a className="text-blue-500" href="https://www.facebook.com/tiqah4education">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                ...
                <a className="ml-4 text-cyan-500">
                  <svg
                    fill="currentColor"
                    strokeLinecap="round"
                    strokeLinejoin="round"
                ...
                <a className="ml-4 text-rose-500" href="https://www.instagram.com/tiqah4education">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    strokeLinecap="round"
