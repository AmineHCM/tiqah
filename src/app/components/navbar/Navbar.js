    ...
    <header className="text-white bg-[--tiqah-blue]">
      <div className="container mx-auto flex flex-wrap py-5 flex-col md:flex-row items-center">
        ...
        <nav className="mx-auto flex flex-wrap font-medium items-center justify-center md:mr-5">
          <a href="/" className="md:mx-2 rounded px-5 py-2 duration-150 ease-in-out hover:bg-blue-100 hover:text-[--tiqah-blue]">Home</a>
          <a href="/" className="md:mx-2 rounded px-5 py-2 duration-150 ease-in-out hover:bg-blue-100 hover:text-[--tiqah-blue]">About</a>
          <a href="/" className="md:mx-2 rounded px-5 py-2 duration-150 ease-in-out hover:bg-blue-100 hover:text-[--tiqah-blue]">Services</a>
          <a href="/" className="md:ml-2 md:mr-5 rounded px-5 py-2 duration-150 ease-in-out hover:bg-blue-100 hover:text-[--tiqah-blue]">Contact</a>
        </nav>
