        ...
        <div className="overlay h-full">
          <div className="container mx-auto flex h-full p-4 md:flex-row flex-col items-center md:align-middle">
            ...
            <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
              <Image src="/assets/graphic-charter/Tiqah Fondation.png" className="rounded-full ring-2 md:ring-4 ring-white shadow-lg w-1/2 mx-auto md:w-full md:mx-0" alt='Tiqah Fondation' width="500" height="500"/>
            </div>
          </div>
        </div>
      </section>            
